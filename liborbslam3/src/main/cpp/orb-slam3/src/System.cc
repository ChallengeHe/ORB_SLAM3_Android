...
//            bool bVocLoad = mpVocabulary->loadFromTextFile(strVocFile);
    ...
    auto handleLocalMapping = mptLocalMapping->native_handle();//获取原生句柄
    pthread_setname_np(handleLocalMapping,"LocalMappingThread");
    ...
    auto handleLoopClosing = mptLoopClosing->native_handle();//获取原生句柄
    pthread_setname_np(handleLoopClosing,"LoopClosingThread");
